...
| Ext Fig 4A | `HARP/Fig5_B_plasma.ipynb` | `figures/figure5/Default HVG clustering markers-vs-Curated gene set.svg` |
| Ext Fig 4B | `HARP/Fig5_Feature_selection_benchmark.ipynb` | `figures/figure5/tradeoff/n_hvg_B_tradeoff.svg` |
